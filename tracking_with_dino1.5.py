...
video_dir = "/home/hazel/Sources/Grounded-SAM-2/custom_video_frames"
...
frame_names.sort(key=lambda p: int(os.path.splitext(p)[0].split(".")[0].split("-")[-1]))
...
# prompt grounding dino to get the box coordinates on specific frame
    ...
    API_TOKEN_FOR_GD1_5 = "277e9d10be096b87c8d47aff833de5f0"
...
"""
CommonUtils.draw_masks_and_box_with_supervision(video_dir, mask_data_dir, json_data_dir, result_dir, stick_to_raw_resolution=True)
