...
class CommonUtils:
    ...
    @staticmethod
    def draw_masks_and_box_with_supervision(raw_image_path, mask_path, json_path, output_path, stick_to_raw_resolution=False):
        ...
        for raw_image_name in raw_image_name_list:
            ...
            # resize it to height 384, width 512
            if not stick_to_raw_resolution:
